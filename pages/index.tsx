    ...
    return (
        <>
            ...
            <div className="max-w-5xl p-4 lg:p-8 mx-auto prose prose-headings:font-700">
                ...
                <p>
                    I have recently been recreating react components that follow ARIA guidelines,
                    have sexy animations, and are super extensible. This is the consolidated home
                    for that work into the near future.
                </p>
                ...
                <ol>
                    ...
                    <li>
                        <Link href="https://vercel-tabs-component.vercel.app/">Tabs &#x2197;</Link>
                    </li>
                    <li>
