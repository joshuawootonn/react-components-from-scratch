...
import {
    Framer,
    useTabs as useFramerMotionTabs,
} from 'components/vercel-tabs/framer'
import {
    Spring,
    useTabs as useReactSpringTabs,
} from 'components/vercel-tabs/react-spring'
import { Circle, Square, Triangle } from 'components/vercel-tabs/shapes'
import {
    TransitionGroupTabs,
    useTabs as useTransitionGroupTabs,
} from 'components/vercel-tabs/transition-group'
        ...
        <div className="max-w-2xl p-4 lg:p-8 mx-auto prose prose-headings:font-700 ">
            <div className="flex flex-row justify-between items-start">
                ...
                <div className="flex space-x-4">
                    <Link href="https://github.com/joshuawootonn/react-components-from-scratch/blob/main/pages/vercel-tabs.tsx">
                        <svg
                            width="24.5"
                            height="24"
                            viewBox="0 0 98 96"
            ...
            <p>
                ...
                I wrote recreating Vercel&apos;s tabs component.
            </p>
            <h2>CSS</h2>
